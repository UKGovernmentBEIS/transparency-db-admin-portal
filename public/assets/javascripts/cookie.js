var CookieConsent = function () {
    ...
    this.storeCookiePreferencesSet = function () {
      this.createCookie('cookies_preferences_set', true);
    };
  
    this.cookiePreferencesSet = function () {
      return this.readCookie('cookies_preferences_set') || false;
    };
  
    this.deleteCookiePolicy = function () {
      this.createCookie('cookies_policy', '', new Date(1970, 1, 1));
    };
  
    this.retrieveCookiePolicy = function () {
      var cookiePolicy = this.readCookie('cookies_policy');
      if (cookiePolicy) {
        try {
