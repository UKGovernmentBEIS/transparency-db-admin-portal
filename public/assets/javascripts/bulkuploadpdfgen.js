...
function Export(errorsvalidationpass, errorRows, file_upload_name) {
  ...
  console.log(
    "accum=" + JSON.parse(JSON.stringify(errorsvalidationpassjson[0])).row
  );
  console.log(
    "accum=" + JSON.parse(JSON.stringify(errorsvalidationpassjson[0])).columns
  );
  console.log(
    "accum=" +
      JSON.parse(JSON.stringify(errorsvalidationpassjson[0])).errorMessages
  );
  ...
  for (var i = 0; i < errorRows; i++) {
    ...
    var cell = row.insertCell(-1);
    cell.innerHTML = JSON.parse(
      JSON.stringify(errorsvalidationpassjson[i])
    ).row;
    var cell = row.insertCell(-1);
    cell.innerHTML = JSON.parse(
      JSON.stringify(errorsvalidationpassjson[i])
  ...
  dvTable.innerHTML =
    ...
    "<br />" +
    " 1. Fix the errors listed below in the file you uploaded." +
    "<br />" +
    "2. Try to upload the updated file again." +
    "<br />" +
    "<br />";
