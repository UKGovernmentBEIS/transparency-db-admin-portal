...
router.get('/',async(req, res) => {
  ...
  console.log("request :" + JSON.stringify(data));
      ...
      try {
          ...
          res.render('bulkupload/mysubsidymeasures',{pageCount,previous_page,next_page,
            start_record ,end_record,totalrows,current_page_active   })
        ...
        res.render('bulkupload/mysubsidymeasures',{pageCount,previous_page,
            next_page,end_record ,end_record,totalrows,current_page_active,start_page,end_page   })
