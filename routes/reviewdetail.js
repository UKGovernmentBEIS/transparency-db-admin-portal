...
router.post("/", async (req, res) => {
  ...
  if (buttonvalue == "continue") {
    ...
    if (
      ...
      ssn.SubsidyErrors[Additem] = "     Enter the subsidy element full amount";
    ...
    if (!Beneficiary_Name) {
      ...
      ssn.SubsidyErrors[Additem] = "     Enter the recipient organisation name";
    ...
    if (
      ...
      if (ssn.Subsidy_Objective_Global == "Other") {
        ...
        ssn.Subsidy_Objective_Plus_Other_Global = ssn.Subsidy_Objective_Global;
      }
