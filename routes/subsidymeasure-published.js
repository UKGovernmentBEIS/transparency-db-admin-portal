...
router.post("/", async (req, res) => {
  ...
  if (Scheme_Start_Month_Global.length == 1) { Scheme_Start_Month_Global = "0" + Scheme_Start_Month_Global}
  if (Scheme_Start_Day_Global.length < 2 ) { Scheme_Start_Day_Global = "0" + Scheme_Start_Day_Global}
  if (Scheme_End_Month_Global.length < 2) { Scheme_End_Month_Global = "0" + Scheme_End_Month_Global}
  if (Scheme_End_Day_Global.length < 2 ) { Scheme_End_Day_Global = "0" + Scheme_End_Day_Global}
  ...
  if (Subsidy_Adhoc_Global == "Yes") { Subsidy_Adhoc_Global_Flag = true} 
  else {  Subsidy_Adhoc_Global_Flag = false }
