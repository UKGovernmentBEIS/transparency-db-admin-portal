...
router.get("/", (req, res) => {
  ...
  if (
    ...
    ssn.purpose_culture_or_heritage_Global = "";
    ssn.purpose_employment_Global = "";
    ssn.purpose_energy_efficiency_Global = "";
    ssn.purpose_environmental_protection_Global = "";
    ssn.purpose_infrastructure_Global = "";
